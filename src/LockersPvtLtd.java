...
public class LockersPvtLtd {
	...
	public static void main(String[] args) throws IOException {
		...
		while(c) {
			...
			System.out.println("If you want to close the System        : press 3");
			System.out.println();
			...
			{	while(true) {
				...
				if(i<=0 || i>=6) {									//If No is not range the,,,,It working
					...
					System.out.println("Your  entered valid number....  ");
					System.out.println();
